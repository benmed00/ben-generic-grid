(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('generic-components-dxc', ['exports', '@angular/core', 'ng2-smart-table', '@nebular/theme', '@angular/router', '@angular/cdk/drag-drop', '@angular/common/http', 'rxjs/operators', 'rxjs', '@ng-bootstrap/ng-bootstrap', '@angular/common', '@angular/forms', 'ng2-completer', '@angular/material'], factory) :
    (global = global || self, factory(global['generic-components-dxc'] = {}, global.ng.core, global.ng2SmartTable, global.theme, global.ng.router, global.ng.cdk['drag-drop'], global.ng.common.http, global.rxjs.operators, global.rxjs, global.ngBootstrap, global.ng.common, global.ng.forms, global.ng2Completer, global.ng.material));
}(this, function (exports, core, ng2SmartTable, theme, router, dragDrop, http, operators, rxjs, ngBootstrap, common, forms, ng2Completer, material) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var SmartTableService = /** @class */ (function (_super) {
        ...
        SmartTableService.prototype.getSettingsFromGitHub = function () {
            return this._http.get(this.apiUrl + '/settings.ts').pipe(operators.catchError(this.handleError));
        };
    ...
    var SmartTableComponent = /** @class */ (function () {
        function SmartTableComponent(service, componentFactoryResolver, http) {
            ...
            this.source = new ng2SmartTable.ServerDataSource(http, { endPoint: 'datafromServer' });
